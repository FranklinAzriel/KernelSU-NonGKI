...
Baixe o gerenciador do KernelSU em [GitHub Releases](https://github.com/Quixoticly/KernelSU/releases), e instale-o no seu dispositivo:
...
Desde a versão [0.9.0](https://github.com/Quixoticly/KernelSU/releases/tag/v0.9.0), KernelSU suporta dois modos de execução em dispositivos GKI:
...
Esta ferramenta oferece suporte ao macOS, Linux e Windows. Você pode baixar a versão correspondente em [GitHub Release](https://github.com/Quixoticly/KernelSU/releases).
