...
:::info
[KernelSU 1.0 and later versions no longer support non-GKI kernels](https://github.com/Quixoticly/KernelSU/issues/1705). The last supported version is `v0.9.5`, please make sure to use the correct version.
:::
